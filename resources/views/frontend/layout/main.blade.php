                ...
                <div class="row g-5">
                    <div class="col-lg-6 col-xl-3">
                        <div class="footer-item-1">
                            ...
                            <p class="text-secondary line-h">Address: <span class="text-white">Medan, North Sumatra</span></p>
                            <p class="text-secondary line-h">Email: <span class="text-white">Sovia@gmail.com</span></p>
                            <p class="text-secondary line-h">Phone: <span class="text-white">+0123 4567 8910</span></p>
                            <div class="d-flex line-h">
                                <a class="btn btn-light me-2 btn-md-square rounded-circle" href=""><i class="fab fa-instagram text-dark"></i></a>
