                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane fade show active">
                                <div class="row g-4 align-items-center">
                                    <div class="col-3">
                                        <img src="{{ asset('assets/frontend') }}/img/me.png" class="img-fluid w-100 rounded"
                                            alt="">
                                    </div>
                                    <div class="col-9">
                                        <h3>{{ $article->user->name }}</h3>
                                        <p class="mb-0">Saya mahasiswi Universitas Malikussaleh Angkatan 2022.
                                            Saat ini saya sedang mendalami bahasa pemrograman PHP mengggunakan laravel
                                            framework.
                                        </p>
                                    </div>
                                </div>
